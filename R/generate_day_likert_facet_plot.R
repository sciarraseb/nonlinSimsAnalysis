...
center_beta_param_data <- function(day_data) {
  ...
  day_data$estimate[beta_rows] <- beta_fixed_data$estimate - as.numeric(as.character(beta_fixed_data$pop_value))
  day_data$upper_ci[beta_rows] <- beta_fixed_data$upper_ci - as.numeric(as.character(beta_fixed_data$pop_value))
  day_data$lower_ci[beta_rows] <- beta_fixed_data$lower_ci - as.numeric(as.character(beta_fixed_data$pop_value))
