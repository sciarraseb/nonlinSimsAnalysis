...
In Experiment 1, I investigated the number of measurements needed to achieve accurate modelling (i.e., low bias and high precision) under different spacing schedules and natures of change. Before presenting the results of Experiment 1, I will present my design and and analysis goals. For the design, I conducted a 4(measurement spacing:equal, time-interval increasing, time-interval decreasing, middle-and-extreme x 4(number of measurements: 5, 7, 9, 11) x 3(nature of change: population value for the fixed-effect days-to-halfway elevation parameter [$\upbeta_{fixed}$] of 80, 180, or 280) study. For the analysis, I was primarily interested in determining whether, for each spacing schedule, if the number of measurements could be increased so that accurate modelling (i.e., low bias and high precision) could be achieved across all nature-of-change values. As a secondary goal, I was also interested in determining whether any spacing schedule provided optimal modelling accuracy (i.e., low bias and high precision) across all manipulated nature of change values and which nature-of-change values afforded the highest modelling accuracy under each spacing schedule. 
...
For equal spacing, Table \ref{tab:summary-table-equal-spacing-exp2} provides a concise summary of the results for the day-unit parameters (see Figure \ref{fig:exp2_plot_equal} for the corresponding parameter estimation plots). Text within the 'Low Bias' and 'High Precision' columns indicates the number of measurements needed to, respectively, achieve low bias and high precision across all manipulated nature-of-change values. Bolded text in the 'Low Bias' and 'Qualitative Summary' columns indicates the measurement number that, respectively, achieves low bias and the greatest improvements in bias and precision across all day-unit parameters and manipulated nature-of-change values. The 'Error Bar Length' column indicates longest error bar length that results from using the measurement number-sample size pairings in the 'Qualitative Summary' column.
...
kbl(x = summary_table, format = 'latex',
       longtable = T, booktabs = T, centering = T, escape = F,
    #linesep = c('\\cmidrule{1-5}', '\\cmidrule{1-5}', '\\cmidrule{1-5}', ''), 
...
* fixed-effect triquarter-halfway delta parameter ($\upgamma_{fixed}$): seven measurements with $N \ge 200$ or nine measurements with $N \le 100$, which achieve a maximum error bar length of `r errorbar_lengths[2]` days. 
* random-effect days-to-halfway elevation parameter ($\upbeta_{random}$): seven measurements across all manipulated sample sizes, which achieves a maximum error bar length of `r errorbar_lengths[3]` days.
* random-effect triquarter-halfway delta parameter ($\upgamma_{random}$):  seven measurements with $N \ge 100$ or nine measurements with $N \le 50$, which achieve a maximum error bar length of `r errorbar_lengths[4]` days.
...
For time-interval increasing spacing, Table \ref{tab:summary-table-time-inc-exp2} provides a concise summary of the results for the day-unit parameters (see Figure \ref{fig:exp2_plot_time_inc} for the corresponding parameter estimation plots). Text within the 'Low Bias' and 'High Precision' columns indicates the number of measurements needed to, respectively, achieve low bias and high precision across all manipulated nature-of-change values. Bolded text in the 'Low Bias' and 'Qualitative Summary' columns indicates the measurement number that, respectively, achieves low bias and the greatest improvements in bias and precision across all day-unit parameters. The 'Error Bar Length' column indicates longest error bar length that results from using the measurement number-sample size pairings in the 'Qualitative Summary' column.
...
summary_table <- data.frame('Parameter' = c('\\thead[lt]{$\\upbeta_{fixed}$ \\\\ (Figure \\ref{fig:exp2_plot_time_inc}A)}',
                            ...
                            'Low Bias' = c('All cells', 
                                           'All cells', 
                                           'All cells except NM = 5 with \\newline \\textit{N} = 30', 
                                           '\\thead[lt]{\\textbf{NM $\\mathbf{\\ge}$ 9 with \\textit{N} $\\boldsymbol{\\ge}$ 200} or \\\\
                            ...
                            'Qualitative Summary' = c('\\thead[lt]{Largest improvements in precision \\\\
                                                      ...
                                                      '\\thead[lt]{Largest improvements in precision \\\\
                                                        using \\textbf{NM = 7 with} \\textbf{\\textit{N} $\\boldsymbol{\\ge}$ 200} or \\\\
                                                       \\textbf{NM = 9 with \\textit{N} $\\boldsymbol{\\le}$ 100}}', 
...
* fixed-effect days-to-halfway elevation parameter ($\upbeta_{fixed}$): seven measurements with $N \le 50$.
...
* random-effect triquarter-halfway delta parameter ($\upgamma_{random}$):  seven measurements with $N \ge 200$ or nine measurements with $N \le 100$. 
...
For time-interval decreasing spacing, Table \ref{tab:summary-table-time-dec-exp2} provides a concise summary of the results for the day-unit parameters (see Figure \ref{fig:exp2_plot_time_dec} for the corresponding parameter estimation plots). Text within the bias and precision columns indicates the number of measurements needed to achieve either low bias or high precision. Bolded text in the 'Low Bias' and 'Qualitative Summary' columns indicates the measurement number-sample size pairing(s) that, respectively, achieves low bias and the greatest improvements in bias and precision across all day-unit parameters. The 'Error Bar Length' column indicates longest error bar length that results from using the measurement number-sample size pairings in the 'Qualitative Summary' column.
...
errorbar_lengths <- c(paste(errorbar_lengths_nm7_s30$errorbar_length[1], '$^a$', sep = ''), 
                      paste(errorbar_lengths_nm9_s30$errorbar_length[2], '$^a$', sep = ''), 
                      paste(errorbar_lengths_nm7_s30$errorbar_length[3], '$^a$', sep = ''), 
                      paste(errorbar_lengths_nm9_s30$errorbar_length[4], '$^a$', sep = ''))
...
summary_table <- data.frame('Parameter' = c('\\thead[lt]{$\\upbeta_{fixed}$ \\\\ (Figure \\ref{fig:exp2_plot_time_dec}A)}',
                            ...
                            'Low Bias' = c('All cells', 
                                           'All cells', 
                                           'All cells except NM = 5 with \\textit{N} = 30', 
                                           '\\thead[lt]{\\textbf{NM $\\mathbf{\\ge}$ 9 with \\textit{N} $\\boldsymbol{\\in}$ \\{200, 500\\}} \\\\
                                           or \\textbf{NM = 11 with \\textit{N} = 1000}}'),
...
kbl(x = summary_table, format = 'latex',
  ...
  footnote(escape = F, threeparttable = T, general_title = '\\\\textit{Note.}\\\\hspace{-1pc}',
           general = "Bolded text in the `Low Bias' and `Qualitative Summary' columns indicates the number of measurements needed to, respectively, achieve low bias and the greatest improvements in bias and precision across all day-unit parameters (high precision not achieved in the estimation of all day-unit parameters with time-interval decreasing spacing). Parameter names and population values are as follows: $\\\\upbeta_{fixed}$ = fixed-effect days-to-halfway elevation parameter = 180; $\\\\upgamma_{fixed}$ = fixed-effect halfway-triquarter delta parameter = 20; $\\\\upbeta_{random}$ = random-effect days-to-halfway elevation parameter = 10; $\\\\upgamma_{random}$ = random-effect halfway-triquarter delta parameter = 4.", 
            alphabet_title = '\\\\newline',
            alphabet = c('Indicates longest error bar length that results from using the measurement number-sample size pairings in the `Qualitative Summary` column.')) %>% 
  kable_styling(position = 'left') %>%
  landscape(margin = '2.54cm')
```
...
For the random-effect halfway-triquarter delta parameter (Figure \ref{fig:exp2_plot_time_dec}D), bias occurs on the five-measurements line (squares) with all manipulated sample sizes (shown on x-axis), on the seven-measurements line (circles) with all manipulated sample sizes, on the nine-measurements line (triangles) with $N \in \{30, 50, 100, 1000\}$, and on the eleven-measurements line (diamonds) with $N \in \{30, 50, 200\}$. Therefore, using time-interval decreasing spacing, the random-effect halfway-triquarter delta parameter ($\upgamma_{random}$) can be estimated with low bias using nine measurements with $N \in \{200, 500\}$ or using eleven measurements with $N \in \{100, 500, 1000\}$.\footnote{The lack of a decline in bias with an increase in measurement number and sample size likely occurs because of simulation error. Thereofre, the expected decline in bias with increases measurement number and sample size would likely emerge if larger cell sizes (i.e., *N* = 5000).} 

In summary, with time-interval decreasing spacing, low bias is achieved in the estimation of all day-unit parameters using nine measurements with $N \in \{200, 500\}$ or using eleven measurements with $N \in \{100, 500, 1000\}$. 
...
For middle-and-extreme spacing, Table \ref{tab:summary-table-mid-ext-exp2} provides a concise summary of the results for the day-unit parameters (see Figure \ref{fig:exp2_plot_mid_ext} for the corresponding parameter estimation plots). Text within the bias and precision columns indicates the number of measurements needed to achieve either low bias or high precision. Bolded text in the 'Low Bias' and 'Qualitative Summary' columns indicates the measurement number-sample size pairing(s) that, respectively, achieves low bias and the greatest improvements in bias and precision across all day-unit parameters. The 'Error Bar Length' column indicates longest error bar length that results from using the measurement number-sample size pairings in the 'Qualitative Summary' column.
