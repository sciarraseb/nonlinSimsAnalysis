...
schedule existed to handle uncertainty in the pattern of change. Three
...
values). Panels A--B show the parameter estimation plots for the fixed- and random-effect values of the days-to-halfway elevation parameter ($\upbeta_{fixed}$ and $\upbeta_{random}$), respectively. Panels C--D show the parameter estimation plots for the fixed- and random-effect values of the triquarter-halfway delta parameter ($\upgamma_{fixed}$ and $\upgamma_{random}$), respectively. Note that, in Panel A, estimates for $\upbeta_{fixed}$ are centered around their corresponding population values (80, 180, and 280 days), and so the y-axis represents error (in number of days) from the population value.

The estimation for the fixed- and random-effect values of
the days-to-halfway elevation parameter ($\upbeta_{fixed}$ and $\upbeta_{random}$; Figure
\ref{fig:exp1_plot_equal}A--B) and the triquarter-halfway delta parameter
($\upgamma_{fixed}$ and $\upgamma_{random}$; Figure
\ref{fig:exp1_plot_equal}C--D) incur considerable variability when five
...
measurements are taken and the value for the days-to-halfway elevation parameter is 80, the middle
95% of values estimated for the fixed-effect parameter of the triquarter-halfway delta parameter ($\upgamma_{fixed}$; Figure \ref{fig:exp1_plot_equal}H) has a
plausible range that spans approximately `r gamma_equal_5_180$upper_ci - gamma_equal_5_180$lower_ci` days
(`r gamma_equal_5_180$upper_ci` to `r gamma_equal_5_180$lower_ci` days),
but the width of this range decreases to approximately `r gamma_equal_7_180$upper_ci - gamma_equal_7_180$lower_ci` days when
seven measurements are taken (`r gamma_equal_7_180$upper_ci` to `r gamma_equal_7_180$lower_ci` days).
...
Figure \ref{fig:exp1_plot_time_increasing} shows the estimation accuracy for the day-unit parameters when time-interval increasing spacing is used (error bars represent the middle 95% of estimated values and shaded horizontal lines indicate the population
values). Panels A--B show the parameter estimation plots for the fixed- and random-effect values of the days-to-halfway elevation parameter ($\upbeta_{fixed}$ and $\upbeta_{random}$), respectively. Panels C--D show the parameter estimation plots for the fixed- and random-effect values of the triquarter-halfway delta parameter ($\upgamma_{fixed}$ and $\upgamma_{random}$), respectively. Note that, in Panel A, estimates for $\upbeta_{fixed}$ are centered around their corresponding population values (80, 180, and 280 days), and so the y-axis represents error (in number of days) from the population value.

Two patterns exist in the estimates of day-unit parameters with time-interval increasing spacing.. First, for the fixed-effects of the 
days-to-halfway elevation and triquarter-halfway delta parameters ($\upbeta_{fixed}$ and
$\upgamma_{fixed}$; Figure \ref{fig:exp1_plot_time_increasing}A--C) and the random-effect of the days-to-halfway elevation parameter ($\upbeta_{random})$; Figure \ref{fig:exp1_plot_time_increasing}B),  variability increases exponentially when five measurements are taken and
the value set for the days-to-halfway elevation parameter increases from 80 to 280 days. As an example, the
middle 95% of values estimated for the fixed effect of the days-to-halfway elevation parameter
($\upbeta_{fixed}$; Figure \ref{fig:exp1_plot_time_increasing}A) has a range of approximately
...
days) and `r beta_time_inc_5_180$upper_ci - beta_time_inc_5_180$lower_ci` days (`r beta_time_inc_5_180$lower_ci` days to `r beta_time_inc_5_180$upper_ci` days) when the parameter has a population value of 80 and 180 days, respectively, but the width increases to
`r beta_time_inc_5_280$upper_ci - beta_time_inc_5_280$lower_ci` days (`r beta_time_inc_5_280$lower_ci` days to
`r beta_time_inc_5_280$upper_ci` days) when the value 280 days are needed to reach the halfway-elevation point. Second, the large amounts of variability observed for the parameters when five measurements are taken largely disappear when seven or more measurements are taken. As an example, the wide range of `r beta_time_inc_5_280$upper_ci - beta_time_inc_5_280$lower_ci` days observed in estimating the fixed-effect of the days-to-halfway elevation parameter ($\upbeta_{fixed}$) when the 280 days are needed to reach the halfway-elevation point decreases to`r beta_time_inc_7_280$upper_ci - beta_time_inc_7_280$lower_ci` days when seven measurements are taken (see Figure \ref{fig:exp1_plot_time_increasing}A).
...
Figure \ref{fig:exp1_plot_time_decreasing} shows the estimation accuracy for the day-unit parameters when time-interval decreasing spacing is used (error bars represent the middle 95% of estimated values and shaded horizontal lines indicate the population
values). Panels A--B show the parameter estimation plots for the fixed- and random-effect values of the days-to-halfway elevation parameter ($\upbeta_{fixed}$ and $\upbeta_{random}$), respectively. Panels C--D show the parameter estimation plots for the fixed- and random-effect values of the triquarter-halfway delta parameter ($\upgamma_{fixed}$ and $\upgamma_{random}$), respectively. Note that, in Panel A, estimates for $\upbeta_{fixed}$ are centered around their corresponding population values (80, 180, and 280 days), and so the y-axis represents error (in number of days) from the population value.

Two patterns exist in the estimates of day-unit parameters with time-interval decreasing spacing. First, for the fixed-effects of the days-to-halfway elevation and triquarter-halfway delta parameters ($\upbeta_{fixed}$ and $\upgamma_{fixed}$; Figure \ref{fig:exp1_plot_time_decreasing}A and C) and the random-effect of the days-to-halfway elevation parameter ($\upbeta_{random})$; Figure \ref{fig:exp1_plot_time_decreasing}B) variability increases exponentially when five measurements are taken and
the value set for the days-to-halfway elevation parameter decreases from 280 to 80 days. As an example, the
middle 95% of values estimated for the fixed effect of the days-to-halfway elevation parameter
($\upbeta_{fixed}$; Figure \ref{fig:exp1_plot_time_decreasing}A) has a range of approximately `r beta_time_dec_5_280$upper_ci - beta_time_dec_5_280$lower_ci`
(`r beta_time_dec_5_280$upper_ci` days to `r beta_time_dec_5_280$lower_ci` days) and `r beta_time_dec_5_180$upper_ci - beta_time_dec_5_180$lower_ci` days (`r beta_time_dec_5_180$lower_ci` days to `r beta_time_inc_5_180$upper_ci` days) when the parameter has a population value of 280 and 180 days, respectively, but the width increases to `r beta_time_dec_5_80$upper_ci - beta_time_dec_5_80$lower_ci` days (`r beta_time_dec_5_80$lower_ci` days to `r beta_time_dec_5_80$upper_ci` days) when the 80 days are needed to reach the halfway-elevation point. Second, the large amounts of variability observed for the parameters when five measurements are taken largely disappear when seven or more measurements are taken. As an example, the wide range of `r beta_time_dec_5_80$upper_ci - beta_time_dec_5_80$lower_ci` days observed in estimating the fixed-effect of the days-to-halfway elevation parameter ($\upbeta_{fixed}$) when the 80 days are needed to reach the halfway-elevation point decreases to `r beta_time_dec_7_80$upper_ci - beta_time_dec_7_80$lower_ci` days when seven measurements are taken (see Figure \ref{fig:exp1_plot_time_decreasing}A).
...
Figure \ref{fig:exp1_plot_time_mid_ext} shows the estimation accuracy for the day-unit parameters when middle-and-extreme spacing is used (error bars represent the middle 95% of estimated values and shaded horizontal lines indicate the population
values). Panels A--B show the parameter estimation plots for the fixed- and random-effect values of the days-to-halfway elevation parameter ($\upbeta_{fixed}$ and $\upbeta_{random}$), respectively. Panels C--D show the parameter estimation plots for the fixed- and random-effect values of the triquarter-halfway delta parameter ($\upgamma_{fixed}$ and $\upgamma_{random}$), respectively. Note that, in Panel A, estimates for $\upbeta_{fixed}$ are centered around their corresponding population values (80, 180, and 280 days), and so the y-axis represents error (in number of days) from the population value.

Two patterns exist in the estimates of day-unit parameters with middle-and-extreme spacing. First, for all the day-unit parameters except the random effect of the halfway-triquarter delta parameter ($\upgamma_{fixed}$; Figure \ref{exp1_plot_time_mid_ext}D), variability increases considerably when five measurements are taken and the values set for the days-to-halfway elevation parameter has a population value of 80 or 280. As an example, the middle 95% of values estimated for the fixed effect of the days-to-halfway elevation parameter ($\upbeta_{fixed}$; Figure \ref{fig:exp1_plot_time_mid_ext}A) has a range of approximately `r beta_mid_ext_5_180$upper_ci - beta_mid_ext_5_180$lower_ci` days (upper bound of `r beta_mid_ext_5_180$upper_ci` days and a lower bound of `r beta_mid_ext_5_180$lower_ci` days) when the parameter has a population value of 180 days, but the width increases to `r beta_mid_ext_5_80$upper_ci - beta_mid_ext_5_80$lower_ci` days (upper bound of `r beta_mid_ext_5_80$upper_ci` days and a lower bound of `r beta_mid_ext_5_80$lower_ci` days) when the parameter has a population value of 80 and `r beta_mid_ext_5_280$upper_ci - beta_mid_ext_5_280$lower_ci` days (upper bound of `r beta_mid_ext_5_280$upper_ci` days and a lower bound of `r beta_mid_ext_5_280$lower_ci` days) when the parameter has a population value of 280. Second, the large amounts of variability observed for the parameters when five measurements are taken largely disappear when seven or more measurements are taken. As an example, the wide range of `r beta_mid_ext_5_280$upper_ci - beta_mid_ext_5_280$lower_ci` days observed when the days-to-halfway elevation parameter ($\upbeta_{fixed}$) has population value 280 decreases to `r beta_mid_ext_7_280$upper_ci - beta_mid_ext_7_280$lower_ci` when seven measurements are taken (see Figure \ref{exp1_plot_time_mid_ext}C). Note that the 
variability observed when seven measurements are taken  for the random effect of the days-to-halfway elevation parameter ($\upbeta_{random}$) is still considerably high when the population value is 80 or 280, with respective ranges of `r beta__rand_mid_ext_7_280$upper_ci - beta__rand_mid_ext_7_280$lower_ci` and `r beta__rand_mid_ext_7_80$upper_ci - beta__rand_mid_ext_7_80$lower_ci` days for parameter estimates. 
...
```{=tex}
\begin{figure}
  \caption{Parameter Estimate Accuracy Across Measurement Spacing Conditions in Experiment 2}
  \label{fig:exp2_summary_plot}
...
```{=tex}
\begin{figure}
  \caption{Parameter Estimate Accuracy Across Time Structuredness Conditions in Experiment 3}
  \label{fig:exp3_summary_plot}
  \includegraphics{Figures/exp3_summary_plot} \hfill{}
  \caption*{Note.}
\end{figure}
```
